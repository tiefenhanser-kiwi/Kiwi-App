...
const REGISTRY: ReadonlyMap<string, PromptDescriptor> = new Map([
  ...
  // "wizard.surprise.generate" — RETIRED. Surprise Me was removed (D-WS9-237,
  // Redesign Arc Block 2 Part C deleted POST /wizard/surprise-me); D-WS9-191
  // Block 1 (Part D.2) deleted the seed body and added the key to the seed's
  // RETIRED_KEYS sweep; Block 3 (Part D.2) removed the runtime entry here. The
  // key lives on only as a string in historical LLMCallLog rows.
