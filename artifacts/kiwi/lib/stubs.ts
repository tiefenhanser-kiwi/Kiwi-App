...
// ── Import URL / Image parse — WS6 6c-1 / 6c-2 ──
// Real fetch + AI parse landed in WS6 6c-1 (URL) and 6c-2 (image). The mobile
// client lives in `@/lib/api/recipeImport` (importRecipeFromUrl,
// importRecipeFromImage) — no stubs remain for either path.
